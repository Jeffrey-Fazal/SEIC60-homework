...
- Make sure you're browser is open to **your** forked version of this repository on Github (eg [http://github.com/{YOUR_USERNAME}/SEIC60-homework](http://github.com/{YOUR_USERNAME}/SEIC60-homework)).
...
- `cd SEIC60-homework`
- `git remote add upstream https://github.com/Bissmark/SEIC60-homework.git`
...
2. Go to your local homework repo (eg, `cd ~/Projects/SEIC60-homework`);
...
- **Once you're finished, submit a pull request for me to accept your homework**
  - Navigate to your forked version of this repository on Github (eg [https://github.com/{YOUR_USERNAME_HERE}/SEIC60-homework](https://github.com/{YOUR_USERNAME_HERE}/SEIC60-homework)).
  ...
  * **IMPORTANT:**
    ...
    **If you don't mention anything in the Pull Request comments, we will assume you had no problems at all with it, and you will receive no feedback about your homework.**
    If you want to follow up on any issues you had with the homework, the ideal time for that will be during the more unstructured lab time after lunch - come and see Dido/Joel or myself then and we can go over any outstanding questions.
